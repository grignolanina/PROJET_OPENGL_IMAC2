...
Camera::Camera(Player& player)
    : m_player(player), m_horizontal(0.0f), m_vertical(0.0f), m_distance(1.f) {}

Camera::Camera(Player& player, GLfloat horizontal, GLfloat vertical, GLfloat distance)
    : m_player(player), m_horizontal(horizontal), m_vertical(vertical), m_distance(distance){
